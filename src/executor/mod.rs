...
cfg_if::cfg_if! {
    if #[cfg(unix)] {
        pub mod unix;
        pub use unix::{UnixCommand as SystemCommand, init_cmd};
        pub use unix::{decode_output, kill_process_group};
        ...
        pub mod windows;
        pub use windows::{WindowsCommand as SystemCommand, init_powershell_cmd as init_cmd};
        pub use windows::{decode_output, kill_process_group};
