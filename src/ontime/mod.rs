...
use self::leak_check::check_resource_leak;
use self::self_update::{try_restart_agent, try_update};
...
use crate::network::EVENT_CHECK_UPDATE;
...
fn register_update_handlers(
    ...
    dispatcher.register(EVENT_CHECK_UPDATE, {
